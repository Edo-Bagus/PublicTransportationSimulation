...
sim.create_segment((-185, -99), (-340, -99))
sim.create_segment((-340, -101), (-185, -101))
...
#Jalan pojok kiri
sim.create_segment((-349, -90), (-349, -10))
sim.create_segment((-351, -10), (-351, -90))

#24
sim.create_quadratic_bezier_curve((-340, -99), (-349, -99), (-349, -90))
sim.create_quadratic_bezier_curve((-351, -90), (-351, -101), (-340, -101))

#-----------

sim.create_segment((-340, -1), (-185, -1))
sim.create_segment((-185, 1), (-340, 1))
...
#Pertigaan kiri
#40
sim.create_quadratic_bezier_curve((-349, -10), (-349, -1), (-340, -1))
sim.create_quadratic_bezier_curve((-340, 1), (-349, 1), (-349, 10))
sim.create_quadratic_bezier_curve((-340, 1), (-351, 1), (-351, -10))
sim.create_quadratic_bezier_curve((-351, 10), (-351, -1), (-340, -1))
sim.create_segment((-351, 10), (-351, -10))
sim.create_segment((-349, -10), (-349, 10))
...
sim.create_segment((-340, 99), (-160, 99))
sim.create_segment((-160, 101), (-340, 101))
...
sim.create_segment((-370, -101), (-340, -101))
